...
public class Arrays {
    ...
    private Arrays(){
        throw new IllegalStateException("Cannot instantiate Arrays");
    }
    ...
    public static <T> List<T> concat(List<T> array, T... values){
        return concat(array, java.util.Arrays.asList(values));
    }
    ...
    public static <T> List<T> pull(List<T> array, T... values){
        return pullAll(array, java.util.Arrays.asList(values));
    }
    ...
    public static <T> List<T> takeWhile(List<T> array, Predicate<T> predicate){
        Objects.requireNonNull(predicate);
        return takeWhile(array, Common.iArrayPredicateFromPredicate(predicate));
    }
    ...
    public static <T, R> List<T> uniqBy(List<T> array, Function<T, R> iteratee){
        Objects.requireNonNull(array);
        Objects.requireNonNull(iteratee);
        return iUnion(java.util.Arrays.asList(array), iteratee, Objects::equals);
    }
    ...
    public static <T> List<T> without(List<T> array, T... exclusions){
        return without(array, java.util.Arrays.asList(exclusions));
    }
